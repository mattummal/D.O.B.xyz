...
export default class App extends Component {
  componentDidMount() {
    ...
    this._typed = new Typed(this._subtitle, {
      ...
      loop: false,
      showCursor: false,
      strings: ['Data Engineering / Cloud Development / DevOps Engineering', 'My other sites are mattummal.com & mattumm.al', 'Data Engineering / Cloud Development / DevOps Engineering' ]
    })
  }
